        ...
        <div className="container pb-8 sm:pb-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 ">
                ...
                <div className="order-2 sm:order-1 flex flex-col justify-center gap-6">
                    ...
                    tg:text-7xl font-bold ">We serve the richest{""}  <span 
                    data-aos="zoom out"
                    data-aos-delay="300"
                    
                    className="text-primary font-cursive">Coffee </span>in the city</h1>
                ...
                />
                  ...
                  className="bg-gradient-to-r from-primary to-secondary absolute top-2 left-5 p-3 
                  rounded-xl">
                    <h1>Hey Coder</h1>
                    </div>
                    ...
                    <div
                    data-aos="fade-right"
                    className="bg-gradient-to-r from-primary to-secondary absolute bottom-2 right-5 p-3 
                    rounded-xl">
                    <h1>Best Coffee</h1>
                    </div>
