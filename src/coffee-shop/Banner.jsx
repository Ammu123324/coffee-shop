 ...
 const Banner =() => {
  return (
    ...
    <div style={bgImage}>
      ...
      <div className='container min-h-[600px] flex justify-center items-center py-12 sm:py-0'>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'> 
            {/* image section */}
            <div data-aos="zoom-in">
                <img src={BannerImg}  alt="" className=" max-w-[500px] w-full mx-auto spin
                drop-shadow-xl" 
            ...
            <div className='flex flex-col justify-center gap-6 sm:pt-0'>
              ...
              <p data-aos="fade-up"
              className='text-sm text-gray-1000 tracking-wide leading-5'>Premium coffee is coffee made from high-quality beans that are carefully sourced,
