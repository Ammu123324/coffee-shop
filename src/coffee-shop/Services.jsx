...
const Services = () => {
  return (
    <>
      {/* Correctly placed Services section */}
      <span id="Services"></span> {/* This is where the page scrolls to when the Services link is clicked */}
      <div className="py-10 min-h-screen mt-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-14 md:gap-5 place-items-center">
            {ServicesData.map((data, index) => (
              <div
                ...
                key={index}
                className="rounded-2xl bg-white hover:bg-primary hover:text-white shadow-2xl duration-200 max-w-[300px] group relative"
              >
                ...
                <div className="p-4 text-center">
                  ...
                  <p className="text-gray-1000 group-hover:text-white duration-300 text-sm line-clamp-2">
                    {data.description}
                  </p>
                </div>
              </div>
